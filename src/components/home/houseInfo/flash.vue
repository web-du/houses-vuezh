<template>
    <div id="newFlash">
        ...
        <div class="nav" id="nav">
            <ul>
                <li :class="{now : isclass==index}"  v-for="(item,index) in categorynav"  :key="index"  @click="tabfun(index,item.name,item.id)">{{item.name}}</li>
            </ul>
        </div>
        <layout>
...
.nav ul li.now{text-decoration: underline;}
</style>