                ...
                <div class="infor">
                  ...
                  <ul>
                      <li class="clearfix" v-for="(item,index) in Buyinfor" :key = "index">
                        ...
                        <span class="size">{{item.huxing}}</span>
                        <span class="acreage">{{item.map}}</span>
                        <span class="rent">{{item.price}}</span>
                        <span class="op fr">
                            <span>修改</span>
                            <span>删除</span>
                        </span>
    ...
    export default{
        ...
        methods:{
            Switch(index){
                ...
                this.axios.get(process.env.API_HOST+'commonality/personal/leasehouse',{params:{type:index}}).then((response) => {
        ...
        created(){
            this.axios.get(process.env.API_HOST+'commonality/personal/leasehouse',{params:{type:0}}).then((response) => {
