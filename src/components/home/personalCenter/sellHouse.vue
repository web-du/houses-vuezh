    ...
    export default{
        ...
        methods:{
            Switch(index){
                ...
                this.axios.get(process.env.API_HOST+'commonality/personal/salehouse',{params:{type:index}}).then((response) => {
        ...
        created(){
            this.axios.get(process.env.API_HOST+'commonality/personal/salehouse',{params:{type:0}}).then((response) => {
