<template>
    <div class="sec-house-page clearfix">
        <div class="item-box fl">
            <ul class="clearfix">
                <li v-for="(item,index) in getPriceDownList" :key="index">
                    <router-link :to="{path:'/handHouse/estateDetails',query:{id:item.id}}">
                        ...
                        <div class="price">
                            ...
                            <p class="rise">环比上月：<img src="@/assets/images/Dw-down.png" ><span>{{item.rate | Removepercent }}</span>%</p>
                        </div>
                    </router-link>
                </li>
            </ul>
