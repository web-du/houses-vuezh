                                ...
                                <ul>
                                 <li v-for="(item,index) in recruit" :key="index" >
                                    <div class="houses_info">
                                         <router-link  class="houses_img" :to="{path:'/renting/rentdetails', query:{id:item.id}}">
                                        ...
                                        <div class="houses_describe">
                                            ...
                                            <div class="addr">
                                                ...
                                                <span>{{housetype(item.house_type)}}.{{item.b_acreage}}.{{item.b_orientation}}.精装</span>
...
<script>
    export default {
        ...
        created(){
             ...
             this.axios.post(process.env.API_HOST +'house/buildings/buildings',{page:1,size:10,b_lease:1,b_type:3,house_operast:2}).then((response) => {      
